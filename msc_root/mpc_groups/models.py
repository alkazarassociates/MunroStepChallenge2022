...
class MpcAdminRegistration(models.Model):
    ...
    secondary_group = models.CharField('Optional Second Group', max_length=60, blank=True, help_text="If you are the admin of another group, you can enter it here to request your two groups being on the same Team.")
